...
def main_gauss(page: ft.Page):
    ...
    num_matriz = ft.TextField(label="Dimensiones", width=100)
    ...
    def click_gen(e):
        value = num_matriz.value
        if num_matriz.value == "Error de tamaño":
            num_matriz.value = "Error de tamaño"
            page.update()
            return
        if not value or int(value) <= 0 or int(value) >=9:
            num_matriz.value = "Error de tamaño"
            page.update()
            return
        n = int(value)
